...
grettings; //won't work, needs ()
greetings();

// Create a function that, when invoked, ilsts out the numbers 1-20, name our function "couting".
...
returnToMeTheResultOfHavingCoffee(); //Why doesn't it display the return value....hmm
...
//the function call being assigned here is hanging onto the treutrned value that we see above
